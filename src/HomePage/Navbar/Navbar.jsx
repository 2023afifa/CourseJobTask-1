...
const Navbar = () => {
    ...
    const navLink =
        <>
            ...
            <li><NavLink className="mr-2" to="/signup">Register</NavLink></li>
        </>
        ...
        <div>
            <div className="navbar bg-slate-50 px-10">
                <div className="navbar-start">
                    ...
                    <a className="text-3xl font-bold">Task Magnet</a>
                </div>
                ...
                <div className="navbar-end">
                    {
                        user ?
                            ...
                            :
                            <Link to="/login"><button className="btn bg-transparent">Log In</button></Link>
                    }
                </div>
            </div>
        </div>
