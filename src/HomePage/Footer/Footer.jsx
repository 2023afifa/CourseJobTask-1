const Footer = () => {
    return (
        <div className="mt-20">
            <footer className="footer footer-center p-20 bg-black text-gray-200">
                <aside>
                    <p>
                        <span className="text-3xl font-bold">Task Magnet Ltd.</span> <br />
                        <span className="text-xl font-medium">Providing reliable tech since 2000</span>
                    </p>
